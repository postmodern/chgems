...
## Install
    ...
    wget https://github.com/downloads/postmodern/chgems/chgems-0.2.2.tar.gz
    tar -xzvf chgems-0.2.2.tar.gz
    cd chgems-0.2.2/
    make install
...
with:
    ...
    wget https://github.com/downloads/postmodern/chgem/chgems-0.2.2.tar.gz.asc
    gpg --verify chgems-0.2.2.tar.gz.asc chgems-0.2.2.tar.gz
